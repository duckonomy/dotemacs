;;; clowns-theme.el --- Not-so-colorful-theme -*- lexical-binding: t -*-

;; URL: https://github.com/ranmaru22/clowns-theme.el
;; Author: ranmaru22
;; Version: 1.1
...
;; screen. Based on clowns.nvim by aktersnurra, converted and extended
;; for Emacs by ranmaru22.
;;
;; Original nvim theme: https://github.com/aktersnurra/clowns.nvim
...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))) ;; GUI only for now
  ...
  (blue               "#a5ffc0") ;;
  (gray-blue          "#7eae81") ;;
  (medium-gray-blue   "#a2c1a8") ;;
  (dark-gray-blue     "#425247") ;;
  (cyan               "#88a9af")
  (red                "#CC6666")
  (green              "#A5D6FF") ;;
  (light-green        "#7E97AB") ;;
